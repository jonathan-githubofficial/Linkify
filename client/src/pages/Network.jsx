                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-md font-medium text-gray-900 truncate dark:text-white">
                                  <div className="flex items-center">
                                    <div className="w-auto">{network.name}</div>
                              ...
                              <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                ...
                                <button
                                  ...
                                  className="mr-2 whiteBtn btn btn-sm bg-sky-400 font-light mt-3"
                                >
                                  {t("networks.accept")}
                                </button>
              ...
              <div className="flow-root">
                ...
                >
                  {connectionsData && connectionsData.length == 0 && (
                    <div className="text-center">{t("networks.noNetwork")}</div>
                  )}
                      ...
                      <li className="p-3 sm:py-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                            {/* <StartDM userId={connections._id} userName={connections.name} /> */}
                            <Link
                              to={`/messages/${connections._id}/${connections.name}`}
                            >
                              <div
                                data-tooltip-target="tooltip-network-msg"
                            ...
                            <button
                              ...
                              data-tooltip-target="tooltip-network-remove"
                              className="mr-2 btn btn-ghost btn-circle"
                            >
                              <HiUserRemove className="text-xl" />
                            </button>
                            <div
                              id="tooltip-network-remove"
                              role="tooltip"
                              class="absolute text-sm z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"
                            >
                              {t("networks.remove")}
                              <div
                                class="tooltip-arrow"
