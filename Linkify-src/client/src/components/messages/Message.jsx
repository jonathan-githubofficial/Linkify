...
function Message(props) {
  ...
  const [isReportedMessageVisible, setIsReportedMessageVisible] =
    useState(false);
          ...
          return (
            <div className="alert shadow-lg bg-red-200">
              ...
              <div className="flex-none">
                <button onClick={showReportedMessage} className="btn btn-sm">
                  View
                </button>
              </div>
            </div>
            ...
            <div className="chat chat-start">
              ...
              <div className="chat-header">
                <div className="flex items-center">
                  <div className="w-auto">{`${message.name} `}</div>
