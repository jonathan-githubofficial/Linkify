...
const PostPopup = ({ post, closePopup, postComment, currentUserId }) => {
  ...
  return (
    <div className="fixed overflow-y-scroll inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 mb-12">
      <div className="relative bg-white pt-15 p-6 w-full max-w-4xl rounded-lg">
        <button
