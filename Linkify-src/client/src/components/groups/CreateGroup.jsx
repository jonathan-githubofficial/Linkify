...
export default function CreateGroup() {
  ...
  const createGroup = async (e) => {
    ...
    await axios
      .post("/api/groups/createGroup", newGroup, headers)
      .then((res) => {
          ...
          <div className="flex lg:gap-8">
            ...
            <div className="w-full w-full lg:w-3/4 bg-white relative lg:rounded-t-xl p-5">
              ...
              <div className="flex flex-col justify-between gap-3">
                <h2 className="flex justify-center text-2xl font-bold md:text-3xl">
                  {t("groups.newGroup")}
                </h2>
              </div>
              ...
              {isCreated == true && (
                <div
                  ...
                  role="alert"
                >
                  <span class="font-medium">{t("groups.success")}</span>
                </div>
              )}
              ...
              <div className="m-12">
                ...
                <div className="text-gray-500 text-sm">{t("groups.note")}</div>
              </div>
            </div>
          </div>
        </div>
