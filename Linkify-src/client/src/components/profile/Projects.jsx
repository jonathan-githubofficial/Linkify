    ...
    return (
        <div className='p-5'>
            <div className="grid grid-col-2 mb-2 flex">
                ...
                <div>
                    {(projects && projects.length == 0) ? 'You did not add your projects yet.' : ''}
                    {projects && Object.keys(projects).slice(0).reverse().map((proj) => {
                        var project = projects[proj];
                        const title_comma_split = project.indexOf(',');
                        const date_comma_split = project.indexOf(',', (title_comma_split + 1));
                        ...
                        const description_comma_split = project.indexOf(',', (date_comma_split + 1));
                        ...
                        var date_str = project.substring(title_comma_split + 1, date_comma_split);
