...
export default function EditProfile(props) {
  ...
  const updateProfile = async (e) => {
    ...
    await axios
      .put("/api/account/updateProfile/", updated_profile, headers)
      .then((res) => {
  ...
  const updatePassword = async (e) => {
    ...
    await axios
      .put("/api/account/updatePassword", password_changed, headers)
      .then((res) => {
  ...
  const verifyPassword = (currentPass) => {
    ...
    axios
      .post("/api/account/matchPassword", password_auth, headers)
      .then((res) => {
  ...
  const deleteAccount = async () => {
    const confirmation = window.confirm(
      t("userProfile.editProfile.deleteAccConfirm")
    );
    ...
    await axios
      .delete(`/api/account/deleteUser?id=${profile._id}`, { headers })
      .then((res) => {
        ...
        <div className="modal-box w-11/12 max-w-5xl editProfileModals">
          ...
          <div>
            <h1 className="text-xl font-semibold mb-5">
              {t("userProfile.editProfile.title")}
            </h1>
            <hr />
              ...
              <div className=" mx-auto">
                  ...
                  >
                    <li className="mr-2" role="presentation">
                      <button
                        ...
                        aria-selected="true"
                      >
                        {t("userProfile.editProfile.basicInfo")}
                      </button>
                    </li>
                    <li className="mr-2" role="presentation">
                      <button
                        ...
                        id="password-tab"
                        data-tabs-target="#password_tab"
                        type="button"
                        role="tab"
                        aria-controls="password_tab"
                        aria-selected="false"
                      >
                    ...
                    <li className="mr-2" role="presentation">
                      <button
                        ...
                        aria-selected="false"
                      >
                        {t("userProfile.editProfile.settings")}
                      </button>
                    </li>
                  </ul>
                </div>
                <div id="myTabContent">
                  ...
                  >
                    <form>
                      <div className="form-control w-full max-w-xs">
                        {profile_updated == 1 && (
                          ...
                          >
                            ...
                            <span class="sr-only">{t("editProfile.info")}</span>
                            <div class="ml-3 text-sm font-medium">
                              {t("userProfile.editProfile.success")}
                            </div>
                            <button
                              type="button"
                            ...
                            >
                              <span class="sr-only">
                                {t("userProfile.editProfile.close")}
                              </span>
                              <svg
                                aria-hidden="true"
                                class="w-5 h-5"
                        ...
                        <div>
                          <label className="label">
                            <span className="label-text">
                              {t("userProfile.editProfile.fullName")}
                            </span>
                          </label>
                          <input
                            type="text"
                            ...
                            onChange={handleName}
                            name="fullname"
                            placeholder={t("userProfile.editProfile.fullName")}
                        ...
                        <div className="mt-5">
                          ...
                          <input
                            ...
                            name="email"
                            placeholder={t("userProfile.editProfile.email")}
                            className="input input-sm input-bordered w-full max-w-xs"
                          />
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="primaryBtn btn btn-sm mt-5"
                      >
                        {t("userProfile.editProfile.update")}
                      </button>
                    </form>
                  </div>
                  ...
                  >
                    <form>
                      <div className="form-control w-full max-w-xs">
                        {pass_verified == 1 && (
                          ...
                          >
                            ...
                            <div class="ml-3 text-sm font-medium">
                              {t("userProfile.editProfile.passSuccess")}
                            </div>
                            <button
                              type="button"
                              class="ml-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700"
                        ...
                        {pass_verified == 2 && (
                          ...
                          >
                            ...
                            <span class="sr-only">
                              {t("userProfile.editProfile.info")}
                            </span>
                            <div class="ml-3 text-sm font-medium">
                              {t("userProfile.editProfile.passError")}
                            </div>
                            <button
                              type="button"
                        ...
                        <div>
                          <label className="label">
                            <span className="label-text">
                              {t("userProfile.editProfile.typeCurrPass")}
                            </span>
                          </label>
                          <input
                            type="password"
                        ...
                        <div className="mt-5">
                          <label className="label">
                            <span className="label-text">
                              {t("userProfile.editProfile.typeNewPass")}
                            </span>
                          </label>
                          <input
                            type="password"
                        ...
                        <div className="mt-5">
                          <label className="label">
                            <span className="label-text">
                              {t("userProfile.editProfile.retypePass")}
                            </span>
                          </label>
                          <input
                            type="password"
                      ...
                      <button
                        ...
                        className="primaryBtn btn btn-sm mt-5"
                      >
                        {t("userProfile.editProfile.updatePass")}
                      </button>
                    </form>
                  </div>
                  ...
                  >
                    ...
                    <div>{t("userProfile.editProfile.deleteAccDesc")}</div>
                    <button
                      onClick={deleteAccount}
                      className="mt-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                    >
                      {t("userProfile.editProfile.deleteAcc")}
                    </button>
                  </div>
                </div>
              </div>
