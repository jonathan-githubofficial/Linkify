            ...
            <div className="grid grid-col-2 mb-2 flex">
                ...
                <div>
                    ...
                    {experiences && Object.keys(experiences).slice(0).reverse().map((exp) => {
                        ...
                        const company_comma_split = experience.indexOf(',', (pos_comma_split + 1));
                        ...
                        const description_comma_split = experience.indexOf(',', (country_comma_split + 1));
                        ...
                        var date_str = experience.substring(company_comma_split + 1, date_comma_split);
                        var country_str = experience.substring(date_comma_split + 1, country_comma_split);
                        var description_str = experience.substring(country_comma_split + 1);
