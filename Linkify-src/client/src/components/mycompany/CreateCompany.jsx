...
// Description: Create company component to create a new company
...
export default function CreateCompany() {
  ...
  const createEvent = async (e) => {
    ...
    await axios
      .post("/api/events/createEvent", newEvent, headers)
      .then((res) => {
        ...
        <div class="flex-auto w-full md:w-3/4 lg:w-4/5 lg:p-5">
          <div className="flex lg:gap-8">
            ...
            <div className="w-full w-full lg:w-3/4 bg-white relative lg:rounded-t-xl p-5">
              ...
              <div>
                <h2 className="text-2xl font-bold flex justify-center md:text-3xl">
              ...
              {isCreated == true && (
                <div
                  ...
                  role="alert"
                >
                  <span class="font-medium">{t("events.createSuccess")}</span>
                </div>
              )}
                ...
                <form autoComplete="off">
                  ...
                  <div className="relative mb-6">
                    ...
                    <input
                      ...
                      placeholder="Enter your company's foundation date"
                      value={date}
                    ...
                    />
                    <div
                      className="flex absolute right-0 items-center pr-3 pointer-events-none"
                      style={{ top: "26px", bottom: "0px" }}
                    >
                      <svg
                        aria-hidden="true"
