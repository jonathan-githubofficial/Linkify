...
function Notifications() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 4, age:"14h",user: "Bear", type: "posted", description: "Passionate about Data Governance and Management? My team is growing and we are looking for Data Stewards to continuously bring value to our data consumers and producers.", avatar: "/images/avatar4.jpg" },
