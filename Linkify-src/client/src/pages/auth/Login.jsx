      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div>
            <button
              type="button"
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-[#4285F4] py-2 px-4 text-sm font-medium text-white hover:bg-[#4285F4]/90 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              onClick={googleAuth}
            >
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                <svg
          ...
          <div>
            <Link to="/register">
              <button
                type="submit"
                className="group relative flex w-full justify-center rounded-md border border-transparent bg-black py-2 px-4 text-sm font-medium text-white hover:bg-[#4285F4]/90 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
                Create an Account
              </button>
            </Link>
