                                    ...
                                    <div className='flex flex-row justify-between'>
                                        <div className='flex flex-row items-center'>
                                            <figure className="px-5">
                                                <img src={profile_pic} alt="Shoes" className=" w-60 lg:w-40 rounded-full" />
                                            </figure>
                                        ...
                                        <div className='flex flex-col justify-center text-sm p-5'>
                                            <button className="btn-sm font-bold font-light">IGNORE</button>
                                            <button className="w-20 primaryBtn btn btn-sm bg-sky-400 font-light">Accept</button>
                                        </div>
                                    </div>
                        </div>))}
                                    ...
                                    <div className='border p-5'>
                                        <div className='flex flex-col justify-between'>
                                            <div className='flex flex-col items-center'>
                                                <figure className="px-5">
                                                    <img src={profile_pic} alt="pic" className=" w-60 lg:w-40 rounded-full" />
                                                </figure>
                                                <div className='flex flex-col items-center px-4'>
                                                    <label className='text-md pl-2 font-semibold'>
                                                        {suggestion.name}
                                                    ...
                                                    <p className='text-center text-bold primaryGray text-[0.8rem] mt-2'>
                                                        {suggestion.title} at {suggestion.company} at {suggestion.location}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className='text-center justify-center text-sm p-5'>
                                                <button className="w-20 primaryBtn btn btn-sm bg-sky-400 font-light">Follow</button>
                                            </div>
                                        </div>
                                    </div>
                                    <hr className='mt-5' />
